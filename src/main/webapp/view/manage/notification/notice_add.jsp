                    ...
                    <div class="row" style="margin-right: 40px;margin-left: 0px;">
                        <form class="form-horizontal" id="select_form" action="${ctx}/score/selectByCondition" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="title" id="title_input" autocomplete="off">
                                </div>
                                <label class="col-sm-1 control-label">类型：</label>
                                <div class="col-sm-3">
                                    <select class="form-control m-b" name="category" id="category_input">
                                        <option style='display: none'></option>
                                        <option value="日常通知">日常通知</option>
                                        <option value="教师寄语">教师寄语</option>
                                        <option value="规章制度">规章制度</option>
                                        <option value="缴费信息">缴费信息</option>
                                    </select>
                                </div>

                                <label class="col-sm-1 control-label">标签：</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="label" id="label_input" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="author" id="author_input" autocomplete="off" />
                                </div>
                                <label class="col-sm-1 control-label">摘要：</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="profile" id="profile_input" autocomplete="off" />
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    $("#submit_btn").click(function () {
        ...
        var data = {'context':context,'title':title,'category':category,'label':label,'author':author,'profile':profile};
