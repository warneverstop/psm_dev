...
<section class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <img src="${ctx}/view/parent/assets/images/spotlight.jpg" alt="" class="img-responsive">
        </div>
        <div class="col-md-8">
            <p style="text-indent:2em;">${majorInfo.profile}</p>
            <blockquote class="blockquote-1">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Anim pariatur cliche reprehenderit,
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="title-box clearfix ">
                <h2 class="title-box_primary">学生信息</h2>
            </div>
            <table class="table">
                <tr>
                    <td>学生姓名：</td>
        ...
        <div class="col-md-4">
            <div class="title-box clearfix ">
                <h2 class="title-box_primary">通知公告</h2>
            </div>
            <div class="list styled custom-list">
                <ul>
                    <c:forEach items="${noticeList}" var="noticeInfo">
                        <li>
                            <a href="${ctx}/notice/selectByIdToShow?noticeId=${noticeInfo.noticeId}">${noticeInfo.title}</a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
        ...
        <div class="col-md-4">
            <div class="title-box clearfix ">
                <h2 class="title-box_primary">行为动态</h2>
            </div>
            <div class="list styled custom-list">
                <ul>
                    <c:forEach items="${actionList}" var="actionInfo">
                        <li>
                            <a href="${ctx}/student/synthesizeSelect">${actionInfo.actionTitle}</a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
            ...
            <c:forEach items="${exerciseList}" var="exerciseInfo">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                    <div class="newsBox">
                        <div class="thumbnail">
                            <figure>
                                <time datetime="2016-01-01"><fmt:formatDate value="${exerciseInfo.happenTime}" type="date"/></time>
                                <img src="${exerciseInfo.firstImgUrl}" alt="" height="178" width="263">
                            </figure>
...
<script>
    history.pushState(null,null,'http://localhost:8080/parent/index');
</script>
</body>
