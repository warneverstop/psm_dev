...
<section class="container">
   <div class="row">
       <h2 align="center" style="line-height:200%;font-family:微软雅黑;font-size:24px;color:#06F;font-weight:normal;margin-bottom: 0px;">
           ${noticeInfo.title}
       </h2>
       <div align="center" style="line-height:400%;color:#444444;font-size:14px">
           时间：<fmt:formatDate value="${noticeInfo.addTime}" type="date" dateStyle="long"/>&nbsp;&nbsp;&nbsp;&nbsp;作者：${noticeInfo.author}&nbsp;&nbsp;&nbsp;&nbsp;点击率：[<span >${noticeInfo.visitCount}</span>] 次
       </div>
   </div>
    <div class="row">
        ${noticeInfo.context}
